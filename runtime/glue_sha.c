...
value make_Coq_Init_Datatypes_comparison_Eq(void);
value make_Coq_Init_Datatypes_comparison_Lt(void);
value make_Coq_Init_Datatypes_comparison_Gt(void);
...
value make_compcert_lib_Integers_Byte_int_mkint(value, value, value *);
value alloc_make_compcert_lib_Integers_Byte_int_mkint(struct thread_info *, value, value);
...
unsigned long long get_Coq_Init_Datatypes_comparison_tag(value);
unsigned long long get_Coq_Init_Datatypes_nat_tag(value);
unsigned long long get_compcert_lib_Integers_Byte_int_tag(value);
...
void print_Coq_Init_Datatypes_comparison(value);
void print_Coq_Init_Datatypes_nat(value);
void print_compcert_lib_Integers_Byte_int(value);
...
signed char const names_of_Coq_Init_Datatypes_comparison[3][3] = { 69, 113,
  0, 76, 116, 0, 71, 116, 0, /* skip 0 */ };

signed char const names_of_Coq_Init_Datatypes_nat[2][2] = { 79, 0, 83, 0,
  /* skip 0 */ };

signed char const names_of_compcert_lib_Integers_Byte_int[1][6] = { 109, 107,
  105, 110, 116, 0, /* skip 0 */ };
...
value make_compcert_lib_Integers_Byte_int_mkint(value $arg0, value $arg1, value *$argv)
{
  *($argv + 0LL) = (value) 2048LL;
  *($argv + 1LL) = $arg0;
  *($argv + 2LL) = $arg1;
...
value alloc_make_compcert_lib_Integers_Byte_int_mkint(struct thread_info *$tinfo, value $arg0, value $arg1)
{
  register value *$argv;
  $argv = (*$tinfo).alloc;
  *($argv + 0LL) = 2048LL;
...
unsigned long long get_Coq_Init_Datatypes_comparison_tag(value $v)
{
  register unsigned long long $t;
  $t = get_unboxed_ordinal($v);
  return $t;
...
unsigned long long get_compcert_lib_Integers_Byte_int_tag(value $v)
{
  register unsigned long long $t;
  $t = get_boxed_ordinal($v);
  return $t;
...
void print_Coq_Init_Datatypes_comparison(value $v)
{
  register unsigned int $tag;
  $tag = get_Coq_Init_Datatypes_comparison_tag($v);
  printf(*(names_of_Coq_Init_Datatypes_comparison + $tag));
}
...
void print_compcert_lib_Integers_Byte_int(value $v)
{
  register unsigned int $tag;
  register void *$args;
  $tag = get_compcert_lib_Integers_Byte_int_tag($v);
  switch ($tag) {
    case 0:
      $args = get_args($v);
      printf(lparen_lit);
      printf(*(names_of_compcert_lib_Integers_Byte_int + $tag));
      printf(space_lit);
      print_Coq_Numbers_BinNums_Z(*((value *) $args + 0));
      printf(space_lit);
      printf(prop_lit);
      printf(rparen_lit);
      break;
